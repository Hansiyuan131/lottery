...
public class ActivityTest {
    ...
    public void init() {
        ...
        activity.setState(ActivityStateEnum.EDIT.getCode());
        activity.setCreator("xiaofuge");

        StrategyVO strategy = new StrategyVO();
        strategy.setStrategyId(10002L);
        strategy.setStrategyDesc("抽奖策略");
        strategy.setStrategyMode(StrategyModeEnum.SINGLE.getCode());
    ...
    public void test_alterState() {
        log.info("提交审核，测试：{}", JSON.toJSONString(stateHandler.arraignment(100001L, ActivityStateEnum.EDIT)));
