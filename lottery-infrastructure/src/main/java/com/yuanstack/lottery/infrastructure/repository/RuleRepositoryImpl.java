...
import com.yuanstack.lottery.infrastructure.dao.RuleTreeDao;
import com.yuanstack.lottery.infrastructure.dao.RuleTreeNodeDao;
import com.yuanstack.lottery.infrastructure.dao.RuleTreeNodeLineDao;
import com.yuanstack.lottery.infrastructure.po.RuleTree;
import com.yuanstack.lottery.infrastructure.po.RuleTreeNode;
import com.yuanstack.lottery.infrastructure.po.RuleTreeNodeLine;
...
public class RuleRepositoryImpl implements RuleRepository {
    ...
    public TreeRuleRich queryTreeRuleRich(Long treeId) {
        ...
        for (RuleTreeNode treeNode : ruleTreeNodeList) {
            ...
            if (NodeTypeConstants.STEM.equals(treeNode.getNodeType())) {
